  ...
  return (
    <div className="m-4">
      <div className="container w-75 m-auto">
        ...
        <div>
          <h2 className="text-success">Create New Recipe</h2>
        </div>
        <hr />
        <div className="text-success"></div>
        <form
        ...
        >
          <label htmlFor="title" className=" m-2 fs-6 ">
            Recipe Title:
          </label>
          <input
            type="text"
          ...
          />
          <label htmlFor="image" className=" m-2 fs-6 ">
            Recipe Image:
          </label>
          ...
          <label htmlFor="Description" className=" m-2 fs-6">
            Description:
          </label>
          <textarea
            type="text"
          ...
          <br />
          <span
            className="bi bi-plus-circle fs-3 m-2 text-success"
          ...
          <label htmlFor="Servings" className=" m-2 fs-6 ">
            Servings:
          </label>
          <input
            type="text"
          ...
          <label className="m-2 form-label">Preparation Time:</label>
          <div className="mb-2 d-flex align-items-start">
            <input
              ...
              onChange={(e) =>
                setRecipe({ ...recipe, PrepTimeHours: e.target.value })
              }
              required
              placeholder="Hours"
            />
          ...
          <div className="mb-2 d-flex align-items-start">
            <input
              ...
              onChange={(e) =>
                setRecipe({ ...recipe, CookingTimeHours: e.target.value })
              }
              required
              placeholder="Hours"
            />
            <input
              ...
              onChange={(e) =>
                setRecipe({ ...recipe, CookingTimeMins: e.target.value })
              }
              required
              placeholder="Minutes"
            />
          ...
          <label htmlFor="Cuisine" className=" m-2 fs-6 ">
            Cuisine:
          </label>
          <select
            id="Cuisine"
